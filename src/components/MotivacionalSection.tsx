...
export default function MotivacionalSection() {
  ...
  return (
    <>
      <section className="relative bg-gradient-to-r from-[#024E0E] via-[##013709]] to-[#1c1c1c] text-white py-20 px-6 md:px-12 overflow-hidden rounded-2xl shadow-lg max-w-7xl mx-auto my-16">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            <span className="uppercase text-sm tracking-widest text-[#F2960E] font-bold">
              Transforme seu Futuro
            </span>
            <h2 className="text-3xl md:text-4xl font-bold leading-tight">
              Conquiste Seu Curso <br />e Alcance{" "}
              <span className="text-[#F2960E]">Grandes Resultados</span>
            </h2>
            ...
            <div className="flex gap-4 mt-4">
              <a href="#cursos">
                <Button className="bg-[#F2960E] text-white font-bold px-6 py-3 rounded-xl shadow-lg hover:bg-yellow-500 hover:scale-105 transition-transform">
              ...
              <Button
                ...
                className="border-white text-black hover:bg-white hover:text-yellow-600 px-6 py-3 rounded-xl"
              >
