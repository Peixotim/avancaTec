...
export const HeroSection = () => {
  ...
  return (
    <>
      <section
        id="inicio"
        className="w-full bg-gradient-to-br from-[#024E0E] via-[##013709]] to-[#1c1c1c] text-white py-20 px-4 sm:px-6 lg:px-8"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col gap-6">
            <div className="inline-flex items-center gap-2 bg-white/10 text-xs font-semibold py-1 px-3 rounded-full self-start backdrop-blur-sm">
              <GraduationCap className="w-4 h-4 text-[#F2960E]" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <Button
                size="lg"
                className="bg-[#F2960E]  font-bold hover:bg-yellow-700"
                asChild
              >
